      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          <div>
            ...
            >
              SEU PROJETO<br />
              <span style={{ color: '#7C3AED' }}>COMEÇA AQUI.</span>
            </motion.h2>
            ...
            >
              Conta a sua ideia e o problema que você quer resolver. A gente monta um orçamento e entra em contato em até 10 dias.
            </motion.p>

            {[
              'Orçamento em até 10 dias',
            ...
            {sent ? (
              <div className="flex flex-col items-center justify-center py-16 text-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-[#6B7699] text-sm">Vamos montar seu orçamento e entrar em contato em até 10 dias.</p>
                </div>
              </div>
            ) : (
